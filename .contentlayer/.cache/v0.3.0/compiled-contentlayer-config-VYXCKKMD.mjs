...
// src/utils/tailwind_clsx.ts
import clsx from "clsx";
import { twMerge } from "tailwind-merge";

// src/utils/remark_img_to_jsx.ts
import fs from "fs";
...
var contentlayer_config_default = makeSource({
  ...
  mdx: {
    ...
    rehypePlugins: [
      rehypeSlug,
      [rehypePrettyCode, rehype_pretty_code_options_default],
      [
...
//# sourceMappingURL=compiled-contentlayer-config-VYXCKKMD.mjs.map
