...
summary: Uniswap V3 - Concentrated liquidity - Explore tick and position mechanisms. Ticks represent discrete price points within a Uniswap V3 pool, while positions define the liquidity provided by liquidity providers (LPs) at specific price ranges determined by two ticks.
...
**\*Note:** a tick is represented as an **int24** since they are bounded by [-887272, 887272] (discussed in [part 1](https://philho.xyz/blog/blockchain/uniswapV3/01#2.-Tick%20system) of this series).\*

### But why the bit map and 16 | 8 division?
...
- Tick and corresponding $\sqrt P$ boundary ($P =$ price).
...
As mentioned in the tick source code in the beginning of this section:
