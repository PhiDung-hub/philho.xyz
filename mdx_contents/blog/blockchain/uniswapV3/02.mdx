...
The source code for [`Position.sol`](https://github.com/Uniswap/v3-core/blob/v1.0.0/contracts/libraries/Position.sol)
...
Since the position is non-fungible in nature, it will be reasonable to represent them as an NFT.
...
## Tick math and mechanism

The source code for [`Tick.sol`](https://github.com/Uniswap/v3-core/blob/v1.0.0/contracts/libraries/Tick.sol)

```solidity
// SPDX-License-Identifier: BUSL-1.1
pragma solidity >=0.5.0;

// ADDED_NOTE: Visit https://github.com/Uniswap/v3-core/blob/v1.0.0/contracts/libraries/Tick.sol
