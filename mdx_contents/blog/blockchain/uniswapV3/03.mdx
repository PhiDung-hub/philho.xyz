...
\Large{
  ...
  \Delta Y &= L \times \Delta \sqrt{P} \quad (1) \\
  \Delta X &= L \times \Delta \frac{1}{\sqrt{P}} \quad (2)
...
## Position minting - \_modifyPosition
...
The implementation of token swapping involves a substantial amount of code:
...
In the next part, we will reconstruct a minimal example of Uniswap V3 and gaining valuable hands-on experience with the protocol.
