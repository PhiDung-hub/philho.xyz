...
https://beta.nextjs.org/docs/api-reference/components/image#props
...
- A box is a smart pointer to a heap value of type `T`. And a smart pointer is a pointer with additional features like automatic
  ...
  - <strong>For Rust, </strong> a smart pointer is defined mostly as a struct that implements `Deref` - , `Drop` traits. The concept is well
    described in [official book](https://doc.rust-lang.org/book/ch15-00-smart-pointers.html). A [well explanation](https://youtu.be/KYJ95TxEC18)
