...
export default function ResumeEntryHeader({ entity, entityHref, location, positionType, positionPeriod }: EntryHeader) {
  return (
    <div className="text-base sm:text-xl md:text-2xl">
      <div className="sm:flex items-stretch font-bold border-b-2 border-gray-500 pb-2 text-blue-600 dark:text-blue-200">
      ...
      <div className="sm:flex items-stretch font-semibold py-2">
